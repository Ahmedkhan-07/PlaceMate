        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-3 flex-wrap">
                        ...
                        {isOwner && (
                            <Link href="/profile/settings">
                                <button className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-emerald-700 hover:text-emerald-700 transition-all">
                    ...
                    {user?.bio && (
                        <p className="text-sm text-gray-700 dark:text-gray-300 mt-2 max-w-md leading-relaxed">{user.bio}</p>
                    )}
                    ...
                    <div className="flex flex-wrap gap-3 mt-3">
                        ...
                        {user?.githubUrl && (
                            <a href={user.githubUrl} target="_blank" rel="noopener noreferrer"
                                className="flex items-center gap-1.5 text-xs text-gray-500 dark:text-gray-400 hover:text-emerald-700 transition-colors">
