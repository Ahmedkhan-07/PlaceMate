...
const links = [
    { label: 'Aptitude', href: '/aptitude', icon: Brain, color: 'text-blue-700 bg-blue-50 hover:bg-blue-100' },
...
export default function QuickLinks() {
    return (
        <div className="bg-white border border-border rounded-xl p-5 shadow-card">
            <h3 className="text-sm font-semibold text-text-primary mb-4">Quick access</h3>
