...
export default function RankBadge({ rank }) {
    ...
    if (rank === 2) return (
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-gray-400/20 border border-gray-500/30 text-gray-700 dark:text-gray-300 text-sm font-bold">
    ...
    return (
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-gray-200 border border-gray-300 text-gray-500 dark:text-gray-400 text-sm font-medium">
            #{rank}
        </div>
    );
}
